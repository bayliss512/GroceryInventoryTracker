    ...
    ALTER TABLE [Users] ADD [ProfileImagePath] nvarchar(max) NULL;");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var products = new List<Product>
            {
                ...
                new Product { Id = 223, Name = "Paper towels", CategoryId = 16, ImagePath = "/Images/ProductImages/Paper towels.png" },
                new Product { Id = 224, Name = "Toilet paper", CategoryId = 16, ImagePath = "/Images/ProductImages/Toilet paper.png" },
                new Product { Id = 225, Name = "Facial tissues", CategoryId = 16, ImagePath = "/Images/ProductImages/Facial tissues.png" },
                new Product { Id = 226, Name = "Aluminum foil", CategoryId = 16, ImagePath = "/Images/ProductImages/Aluminum foil.png" },
                new Product { Id = 227, Name = "Plastic wrap", CategoryId = 16, ImagePath = "/Images/ProductImages/Plastic wrap.png" },
                new Product { Id = 228, Name = "Sandwich bags", CategoryId = 16, ImagePath = "/Images/ProductImages/Sandwich bags.png" },
                new Product { Id = 229, Name = "Trash bags", CategoryId = 16, ImagePath = "/Images/ProductImages/Trash bags.png" },
                new Product { Id = 230, Name = "Dish soap", CategoryId = 16, ImagePath = "/Images/ProductImages/Dish soap.png" },
                new Product { Id = 231, Name = "Dishwasher detergent", CategoryId = 16, ImagePath = "/Images/ProductImages/Dishwasher detergent.png" },
                new Product { Id = 232, Name = "Laundry detergent", CategoryId = 16, ImagePath = "/Images/ProductImages/Laundry detergent.png" },
                new Product { Id = 233, Name = "Fabric softener", CategoryId = 16, ImagePath = "/Images/ProductImages/Fabric softener.png" },
                new Product { Id = 234, Name = "Sponges", CategoryId = 16, ImagePath = "/Images/ProductImages/Sponges.png" },
                new Product { Id = 235, Name = "Food storage containers", CategoryId = 16, ImagePath = "/Images/ProductImages/Food storage containers.png" },

                // Cleaning Supplies (236-246)
                new Product { Id = 236, Name = "All-purpose cleaner", CategoryId = 17, ImagePath = "/Images/ProductImages/All-purpose cleaner.png" },
                new Product { Id = 237, Name = "Glass cleaner", CategoryId = 17, ImagePath = "/Images/ProductImages/Glass cleaner.png" },
                new Product { Id = 238, Name = "Disinfecting wipes", CategoryId = 17, ImagePath = "/Images/ProductImages/Disinfecting wipes.png" },
                new Product { Id = 239, Name = "Bleach", CategoryId = 17, ImagePath = "/Images/ProductImages/Bleach.png" },
                new Product { Id = 240, Name = "Toilet bowl cleaner", CategoryId = 17, ImagePath = "/Images/ProductImages/Toilet bowl cleaner.png" },
                new Product { Id = 241, Name = "Floor cleaner", CategoryId = 17, ImagePath = "/Images/ProductImages/Floor cleaner.png" },
                new Product { Id = 242, Name = "Scrub brushes", CategoryId = 17, ImagePath = "/Images/ProductImages/Scrub brushes.png" },
                new Product { Id = 243, Name = "Rubber gloves", CategoryId = 17, ImagePath = "/Images/ProductImages/Rubber gloves.png" },
                new Product { Id = 244, Name = "Air freshener", CategoryId = 17, ImagePath = "/Images/ProductImages/Air freshener.png" },
